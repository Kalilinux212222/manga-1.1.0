...
import Logo from '../images/PgLogo.png';
            ...
            <header className="text-black flex w-full items-center justify-between text-center mx-auto bg-gray-200">
                ...
                {nav && (
                    <div className="text-white fixed items-center z-1 w-sm h-full right-0 top-0 border-r border-r-gray-900 bg-gray-700 ease-in-out duration-600 lg:hidden ">
                        <nav className="">
                            <img className="bg-transparent w-[100px]" src={Logo} alt="" />
                            <ul className="mx-auto pt-4">
                                ...
                                <li className="my-1 p-4 rounded-2xl hover:bg-violet-600 focus:outline-2 focus:outline-offset-2 focus:outline-violet-500 active:bg-violet-700"><Link to='/newest'>News</Link></li>
